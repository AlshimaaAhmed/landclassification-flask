...
model_tif_path = hf_hub_download(repo_id= "AlshimaaAhmed/landclassification-models" , filename = "land_restnet.h5")
...
def preprocess_tif_image(file_path, target_size=(224,224)):
    ...
    transformed = pca_model.transform(reshaped)
    transformed = transformed.reshape((target_size[0], target_size[1], -1))
...
def predict():
    ...
    if input_method == 'map':
        ...
        if file_type == 'rgb':
            ...
            arr = preprocess_tif_image(saved_path)
